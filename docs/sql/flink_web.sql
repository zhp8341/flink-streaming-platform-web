...
CREATE TABLE `job_config` (
  ...
  `udf_jar_path` varchar(1024) DEFAULT NULL COMMENT 'udf地址 多个可用英文;分隔 如remote|http://xxx.xxx.com/flink-streaming-udf.jar',
  `udf_register_name` varchar(255) DEFAULT NULL COMMENT 'udf注册名称如 utc2local|com.streaming.flink.udf.UTC2Local 多个可用;分隔',
