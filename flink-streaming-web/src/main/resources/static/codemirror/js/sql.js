...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    CodeMirror.defineMIME("flink/x-fsql", {
        name: "sql",
        keywords: set(" use drop show catalog varchar partition timestamp primary key string int bigint double date boolean" +
            " tinyint samllint float tblproperties decimal varbinary create having or order like set left right join no not" +
            "  limit all for null true false tumble_rowtime minute hour interval select from table with group by order and or date_format timestamp from_timestamp  function view insert  into where join having distinct all sum union all partition over as desc asc count substring type project minute tumble_start tumble_end hop_start hop_end function view  insert into "),
